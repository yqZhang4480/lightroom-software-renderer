...
#ifdef WIN32
#ifdef UNICODE
	#pragma comment(lib,"easyx/EasyXw_x86.lib")
#else
	#pragma comment(lib,"easyx/EasyXa_x86.lib")
#endif
#else
#ifdef UNICODE
	#pragma comment(lib,"easyx/EasyXw_x64.lib")
#else
	#pragma comment(lib,"easyx/EasyXa_x64.lib")
#endif
#endif
